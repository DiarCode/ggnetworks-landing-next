		...
		>
			<div className='mx-auto px-4 lg:px-6 max-w-screen-xl'>
				...
				<div className='mb-8 text-center'>
					...
					<p className='mt-3 text-gray-500 text-lg dark:text-gray-400'>
						{t('map.subtitle')}
					</p>
				</div>

				{/* Map Section */}
				<div className='relative border-gray-300 dark:border-gray-700 border rounded-2xl overflow-hidden'>
					{/* Links Section */}
					<div className='top-0 left-0 z-10 absolute p-2 text-gray-300 text-xs'>
						<Link
